...
public class Shop : MonoBehaviour
{
    ...
    [SerializeField] Button quitButtonMain;
    [SerializeField] GameObject wantToQuitPanel;
    [SerializeField] Button panel_ClosePanel;
    [SerializeField] Button panel_QuitGame;
    ...
    public void Init()
    {
        ...
        panel_QuitGame.onClick.AddListener(backToMenu);
        quitButtonMain.onClick.AddListener(openQuitPanel);
        panel_ClosePanel.onClick.AddListener(closeQuitPanel);
